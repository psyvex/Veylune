...
export function mountMarketingPage(root: HTMLElement): { dispose(): void } {
  root.innerHTML = `<div class="marketing-shell">
    ...
    <main id="top"><section class="marketing-hero" aria-labelledby="hero-title">
      ...
      <canvas class="spatial-canvas" aria-label="Interactive three dimensional room scan. Move the cursor to orbit through 360 degrees, or drag on touch and use the arrow keys. Use the stage controls to explore capture, alignment, and refinement." role="img" tabindex="0"></canvas>
      ...
      <div class="scene-caption"><span class="caption-dot"></span><span data-scene-caption>ROOM / KEYFRAME MAP</span><span class="caption-divider">—</span><b>MOVE CURSOR TO ORBIT</b></div>
