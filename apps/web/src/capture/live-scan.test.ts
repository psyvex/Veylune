...
function camera(): { stream: MediaStream; video: HTMLVideoElement; facingMode: "environment"; stop(): void } { const video = document.createElement("video"); Object.defineProperties(video, { readyState: { value: 2 }, videoWidth: { value: 64 }, videoHeight: { value: 48 } }); return { stream: {} as MediaStream, video, facingMode: "environment", stop() {} }; }
